...
set.seed(1234)
wordcloud(words = apa$word, freq = apa$freq, min.freq=50, max.words=2000, random.order=FALSE, rot.per=0.35, colors=brewer.pal(8, "Dark2"))
